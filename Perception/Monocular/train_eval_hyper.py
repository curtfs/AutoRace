...
if __name__ == "__main__":
    ...
    ##### loss type study ######
    add_bool_arg('loss_type_study', default=False, help="whether to initialize study of three different loss type: l2_softargmax|l1_heatmap|l1_softargmax")
    ############################
    ...
    def objective(trial):
        ...
        if opt.loss_type_study:
            loss_type = trial.suggest_categorical('loss_type', ['l1_softargmax', 'l1_heatmap', 'l1_softargmax'])
        else:
        ...
        result_file = open("logs_k/" + opt.study_name +".txt","r+")
